...
public class ZoomableImageViewJ extends AppCompatImageView {
    //
    ...
    public ZoomableImageViewJ(Context context) {
        this(context, null);
    }

    public ZoomableImageViewJ(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZoomableImageViewJ(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setImageDrawable(Drawable drawable) {
        imageRenderedAtLeastOnce = false;
        drawable.setFilterBitmap(false);//No anti aliasing
    ...
    /**
     * Set zoom parameters equal to another ZoomableImageViewJ. Including scale, position,
     * and ScaleType.
     *
     */
    public void setZoom(ZoomableImageViewJ img) {
    ...
    private class DoubleTapZoom implements Runnable {
        ...
        DoubleTapZoom(float targetZoom, float focusX, float focusY, boolean stretchImageToSuper) {
            ...
            endTouch = new PointF(viewWidth / 2.f, viewHeight / 2.f);
        }
